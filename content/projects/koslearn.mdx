...
tech: [Java, Spring Boot, MyBatis, Thymeleaf, Spring Security, MySQL, Docker, AWS EC2]
...
**CI/CD** — main 브랜치 push → GitHub Actions (bootJar 빌드 → Docker 멀티스테이지 이미지 → push) → GHCR(`ghcr.io/leewj12/koslearn`) → EC2 pull·재기동
