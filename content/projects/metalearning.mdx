...
**팀 프로젝트 당시**
- 공개 페이지 Thymeleaf 프론트엔드 전담 — 메인, 강의 목록·상세, 국비 과정 목록·상세 페이지 구현
- 다른 팀원: React SPA 기반 관리자·매니저·강사 대시보드 담당

**프로젝트 이후 단독 개선**
- **UI 전면 리디자인** — 비로그인 공개 페이지 18개 파일 다크네이비+오렌지 팔레트로 재설계
- **스케줄러 버그 수정** — 시작일이 미래인 세션이 ONGOING으로 잘못 변경되어 신청 버튼 미노출되던 문제 수정
- **S3 영상 업로드 복구** — 로컬 저장 방식으로 되어있던 영상 업로드를 AWS S3로 정상화
